...
// export default async function getMostPopular(endpoint, days) {
//   const url = new URL(`${endpoint}/${days}.json`, BASE_URL);
...
// export async function articleSearch(query, filter) {
